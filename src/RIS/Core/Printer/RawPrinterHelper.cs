...
namespace RIS.Core.Printer
{
    public class RawPrinterHelper
    {
        ...
        public static bool SendBytesToPrinter(string szPrinterName, int szCopies, IntPtr pBytes, int dwCount)
        {
            ...
            di.pDocName = "RIS - Fileprint";
            di.pDataType = "RAW";

            // Open the printer.
            for (var copy = 1; copy <= szCopies; copy++)
        ...
        public static bool SendFileToPrinter(string szPrinterName, int szCopies, string szFileName)
        {
            // Set file attribute
            var fi = new FileInfo(szFileName);
            var attribute = FileAttributes.ReadOnly;
            ...
            bSuccess = SendBytesToPrinter(szPrinterName, szCopies, pUnmanagedBytes, nLength);
            // Free the unmanaged memory that you allocated earlier.
            Marshal.FreeCoTaskMem(pUnmanagedBytes);
            return bSuccess;
        }

        public static bool SendStringToPrinter(string szPrinterName, int szCopies, string szString)
        {
            IntPtr pBytes;
            int dwCount;
            ...
            SendBytesToPrinter(szPrinterName, szCopies, pBytes, dwCount);
